...
class Demo3B1B(Scene):
    def construct(self):
        ...
        L12_0, L12_1 = Lines2TangentsOutCirCir(CIR1, CIR2, None, "t12")
        L23_0, L23_1 = Lines2TangentsOutCirCir(CIR2, CIR3, None, "t23")
        L31_0, L31_1 = Lines2TangentsOutCirCir(CIR3, CIR1, None, "t31")
