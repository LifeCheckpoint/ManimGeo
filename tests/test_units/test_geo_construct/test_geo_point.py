...
def test_ConstraintPoint():
    # 约束点测试
    pass

def test_ExtensionPP():
    # 延长点测试
...
def test_NotImplemented():
    with pytest.raises(Exception):
        Point(args="111") # type: ignore[call-arg]